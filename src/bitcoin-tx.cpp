...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bixbcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bixbcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bixbcoin transaction") + "\n" +
              "  bixbcoin-tx [options] -create [commands]   " + _("Create hex-encoded bixbcoin transaction") + "\n" +
              "\n";
