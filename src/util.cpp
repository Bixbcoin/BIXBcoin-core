...
const char * const BITCOIN_CONF_FILENAME = "bixbcoin.conf";
const char * const BITCOIN_PID_FILENAME = "bixbcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bixbcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bixbcoin";
#else
    // Unix
    return pathRet / ".bixbcoin";
#endif
#endif
}
